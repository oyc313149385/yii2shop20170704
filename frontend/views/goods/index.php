...
<?php //echo \yii\helpers\Html::a(\yii\helpers\Html::img($model->logo,['',]),['class'=>'jqzoom','rel'=>'gal1'])?>
         <!--  第一幅图片的大图 class 和 rel属性不能更改 -->
                <?php 
                //可以强行拼接后台图片地址
                 $url = 'http://admin.yii2shop.com'.$model->logo;
                echo \yii\helpers\Html::a(\yii\helpers\Html::img($url))
                ?>              <!-- 第一幅图片的中图 -->
                </a>
            </div>
