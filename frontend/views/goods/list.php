...
<div class="list w1210 bc mt10">
    ...
    <div class="list_left fl mt10">
        ...
        <div class="newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <li>
                        <dl>
                            <dt><?=\yii\helpers\Html::img('@web/images/list_hot1.jpg')?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt></dt><?=\yii\helpers\Html::img('@web/images/list_hot2.jpg')?></a></dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><?=\yii\helpers\Html::img('@web/images/list_hot3.jpg')?></a></dt>
        ...
        <div class="viewd leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <dl>
                    <dt><?=\yii\helpers\Html::img('@web/images/hpG4.jpg')?></a></dt>
            ...
            <ul>
                ...
                <li>
                        ...
                        <dl>
                            ...
                            <dd><?=$model->id?></dd>
                            <dd><?=$model->name?></dd>
                            <dd><?=$model->shop_price?></dd>
                            <dd><?php echo \yii\helpers\Html::a(\yii\helpers\Html::img($model->logo),['goods/index','id'=>$model->id]) ?></dd>
                            <!--<dd><?=\yii\helpers\Html::a(\backend\models\Goods::findOne(['id'=>$model->id])->logo,['list/xiang','id'=>$model->id])?></dd> -->   
